...
plus = Button(root, text=' + ', fg='white', bg='black', command=lambda: press("+"), height=1, width=7) 
plus.grid(row=2, column=3) 
  
minus = Button(root, text=' - ', fg='white', bg='black', command=lambda: press("-"), height=1, width=7) 
...
equal = Button(root, text=' = ', fg='white', bg='black', command=equalpress, height=1, width=7) 
equal.grid(row=5, column=2) 
  
clear = Button(root, text='Clear', fg='white', bg='black', command=clear, height=1, width=7) 
